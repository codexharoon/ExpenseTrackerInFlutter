...
class MyBarGraph extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    // init bar data
     BarData myBarData = BarData(sunAmount: sunAmount, monAmount: monAmount, tueAmount: tueAmount, wedAmount: wedAmount, thurAmount: thurAmount, friAmount: friAmount, satAmount: satAmount);
